...
export const store = reactive({
  ...
  sosCards: [
    ...
    },
    {
      ...
      description:
        "La fauna selvatica, soprattutto quella in difficoltà, è <strong>particolarmente sensibile ad un alimento non adatto</strong>, il quale può arrecargli diversi problemi, portandola persino alla morte: per questo motivo, <strong>bisognerebbe sempre evitare</strong> di alimentare gli animali.<br><br><h4>Ecco una breve lista di alimenti da evitare assolutamente:</h4><ul class='details-description-list'><li>Latte vaccino e latticini in generale</li><li>Pane</li><li>Biscotti</li><li>Dolciumi</li><li>Alimenti processati</li><br>Per quanto riguarda l'idratazione dell' esemplare, <strong>l'acqua si può somministrare solo in caso di animali vigili e reattivi</strong>, avendo la cura di scegliere contenitori adatti alla dimensione dell'animale: se troppo ingombranti potrebbero essere colpiti accidentalmente da alcuni movimenti dell'animale e rovesciare così il loro contenuto, finendo per bagnare la scatola e l'animale stesso.<br>Nel caso di dimensioni ridotte, come volatili o cuccioli molto piccoli, il tappo di un barattolo è di solito sufficiente.<br><br><h4>Nel caso tu non riesca a portare direttamente l'esemplare in un C.R.A.S., contattalo e chiedi consigli specifici</h4>",
    },
    {
      title: "Chi chiamare",
      image: "sos-animal/cards/3-who-to-call.jpg",
      description:
        "Sparsi sul territorio ci sono i <strong>Centri di Recupero Animali Selvatici</strong> ovvero i <strong>C.R.A.S.</strong><br><br><h4>Che cosa sono?</h4><br>Sono i centri predisposti alla cura e al recupero della fauna, purtroppo però non tutti hanno la possibilità di effettuare il recupero di un esemplare in difficoltà: in questo caso la competenza passa alla Polizia Provinciale.<br><br>Al seguente link puoi trovare l'elenco completo dei C.R.A.S, suddivisi per regione <a href='https://elencocras.it/' target='_blank'>https://elencocras.it/</a>",
    },
    {
      title: "Mammiferi nudi",
      image: "sos-animal/cards/4-naked-mammals.png",
      description:
        "<strong>Se nudi e con occhi chiusi o fuori dal nido, necessitano sempre di intervento.</strong>.<br><br>Un reinserimento nel nido è possibile e consigliabile se non sono feriti e presentano una certa vitalità (ovvero se si muovono e sono caldi e se reagiscono se stimolati) ed il nido risulta accessibile e integro.<br><br><h4>Usa guanti o un panno per evitare di lasciare il tuo odore, altrimenti il genitore potrebbe abbandonarli!<br><br></h4> Una volta riposizionato nella tana è obbligatorio allontanarsi (mai rimanere in vista), mantenere monitorata l'attività di cuccioli e genitori per le successive 4-6 ore e, nel frattempo, contattare il C.R.A.S.",
    },
    {
      title: "Mammiferi con pelo",
      image: "sos-animal/cards/5-furry-mammals.png",
      description:
        "<strong>Non sempre gli animali giovani sono abbandonati</strong>.<br><br>I cuccioli con il mantello sviluppato e gli occhi ben aperti, <strong>iniziano ad esplorare il territorio</strong>, quindi non capita di rado trovare giovani lepri, conigli o scoiattoli da soli: fa parte del loro ciclo di vita.<br><br><h4>È tutto normale ed è una fase fondamentale per la loro crescita, perciò non vanno recuperati.</h4><br>Emblematici sono i <strong>cuccioli di capriolo e cervo</strong>: essi <strong>nascono senza odore</strong> e quando le madri si allontanano per nutrirsi li lasciano per diverso tempo nascosti nella vegetazione. Il loro non avere odore li protegge da eventuali predatori ma, <strong>se toccati, ne acquisiranno uno estraneo alla madre e verranno abbandonati!</strong><br><br><h4>Se la zona di ritrovamento presenta dei pericoli, è buona norma contattare il C.R.A.S. per farsi consigliare.</h4>",
    },
    {
